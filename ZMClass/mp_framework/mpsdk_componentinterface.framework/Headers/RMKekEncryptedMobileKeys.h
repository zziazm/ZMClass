...
// This file generated by Djinni from RMKekEncryptedMobileKeys.djinni
...
/**
 * Auto-generated Djinni interface for ::mpsdk::componentinterface::crypto::keys::RMKekEncryptedMobileKeys_t
 * 
 * Defines a way to retrieve a set of Remote Management keys (MAC, DEK and Transport) that
 * are protected by the RM_KEK key
 * 
 */
 ...
 * 
 */
- (RMKekEncryptedData* _Nonnull)getEncryptedMacKey;
 ...
 * 
 */
- (RMKekEncryptedData* _Nonnull)getEncryptedTransportKey;
 ...
 * 
 */
- (RMKekEncryptedData* _Nonnull)getEncryptedDek;
