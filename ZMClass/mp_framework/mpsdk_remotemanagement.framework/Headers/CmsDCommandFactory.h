...
// This file generated by Djinni from CmsDCommandFactory.djinni
...
/**
 * Auto-generated Djinni interface for ::mpsdk::remotemanagement::commands::CmsDCommandFactory_t
 * 
 * A factory for creating concrete implementations of commands for use with the CMS-D
 * 
 */
@interface CmsDCommandFactory : NSObject<CommandFactory>

- (id _Nonnull)initWithInterfaces:(id<HttpManager> _Nonnull)httpManager remoteManagementCrypto:(id<RemoteManagementCrypto> _Nonnull)remoteManagementCrypto commandEventListener:(id<CommandEventListener> _Nonnull)commandEventListener sessionContextProvider:(id<SessionContextProvider> _Nonnull)sessionContextProvider walletIdentificationDataProvider:(id<WalletIdentificationDataProvider> _Nonnull)walletIdentificationDataProvider communicationParametersProvider:(id<CommunicationParametersProvider> _Nonnull)communicationParametersProvider communicationRetryParametersProvider:(id<CommunicationRetryParametersProvider> _Nonnull)communicationRetryParametersProvider;
 ...
 * @param taskId the unique ID of the request for which the task status should
 * be retrieved
 * @returns the command
 * 
 */
