...
// This file generated by Djinni from GetTaskStatusCommand.djinni
...
/** Auto-generated Djinni interface for ::mpsdk::remotemanagement::commands::impl::GetTaskStatusCommand_t */
@interface GetTaskStatusCommand : BaseRemoteManagementCommand

- (id _Nonnull)initWithRequestId:(NSString* _Nonnull)requestId httpManager:(id<HttpManager> _Nonnull)httpManager remoteManagementCrypto:(id<RemoteManagementCrypto> _Nonnull)remoteManagementCrypto sessionContextProvider:(id<SessionContextProvider> _Nonnull)sessionContextProvider walletIdentificationDataProvider:(id<WalletIdentificationDataProvider> _Nonnull)walletIdentificationDataProvider commandEventListener:(id<CommandEventListener> _Nonnull)commandEventListener communicationParametersProvider:(id<CommunicationParametersProvider> _Nonnull)communicationParametersProvider taskId:(NSString* _Nonnull)taskId communicationRetryParametersProvider:(id<CommunicationRetryParametersProvider> _Nonnull)communicationRetryParametersProvider;
