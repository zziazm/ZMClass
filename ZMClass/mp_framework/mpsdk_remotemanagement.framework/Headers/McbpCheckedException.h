...
// This file generated by Djinni from McbpCheckedException.djinni
...
/**
 * Auto-generated Djinni interface for ::mpsdk::exceptions::McbpCheckedException_t
 * 
 * Generic MCBP Exception_t class
 * It provides an interface for all the exception classes to be used within MCBP modules
 * 
 */
@interface McbpCheckedException : Exception
